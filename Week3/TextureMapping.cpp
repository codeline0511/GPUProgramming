...
int main()
{
    ...
    unsigned char* data1 = stbi_load("resources/textures/stone.jpg", &width, &height, &nrChannels, 0);
    if (data1)
    {
    ...
    unsigned char* data2 = stbi_load("resources/textures/Low-T541_Mineralize.jpg", &width, &height, &nrChannels, 0);
    if (data2)
    {
